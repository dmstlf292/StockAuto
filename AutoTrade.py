...
slack = Slacker('xoxb-1713756351378-1699001014647-nHEYPOhvCCUiJd7irMbBkRk7')
def dbgout(message):
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A252670','A253160','A252420','A252670'] #종목 리스트 안에 있는 대상으로 자동매매가 이루어지게 함
        bought_list = []     # 매수 완료된 종목 리스트
        target_buy_count = 4 # 매수할 종목 수
        buy_percent = 0.25 #25%씩 매수하는것   
